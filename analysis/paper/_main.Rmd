...
# Acknowledgements
We would like to thank a diversity of institutions that provided funding to the work in Vale Boi in the last decade. These are Archaeological Association of Algarve, Fundaç~ao para a Ciência e Tecnologia, Instituto Portugu^es de Arqueologia, National Geographic Society, and Wenner-Gren Foundation for Anthropological Research.
...
---
title: "SOM: The role of lithic bipolar technology in Western Iberia’s Upper Paleolithic: the case of Vale Boi (southern Portugal)"
author: 
  - Pedro Horta (ICArEHB, University of Algarve, Faro, Portugal) pedroehorta@gmail.com
  - João Cascalheira (ICArEHB, University of Algarve, Faro, Portugal) jmcascalheira@ualg.pt
  - Nuno Bicho (ICArEHB, University of Algarve, Faro, Portugal) nbicho@ualg.pt
...
## Technological attributes used in the analysis
...
knitr::kable(techno_attributes, caption= "Technological attributes used in the analysis of scaled pieces included in the study.")

```

\newline

## Morpho-functional attributes used in the analysis
...
knitr::kable(morpho_attributes, caption= "Morpho-functional attributes used in the analysis of each platform of scaled pieces included in the study. *Adapted from Gonzalez-Urquijo and Ibanez-Estévez [-@gonzalez-urquijo_metodologialisis_1994]. **Adapted from de la Peña [-@de_la_pena_sobre_2011].")
