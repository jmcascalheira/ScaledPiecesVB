...
Bipolar technology clearly had an important role on the adaptive systems of the first modern humans in Western Iberia and elsewhere. As mentioned by Shot and Tostevin [-@shott_diversity_2015], a rise in bipolar technology frequency may be related to human mobility patterns and even evolutionary trends [@duke_weaving_2015]. For the first modern humans, as well as their descendants, this technology would have played a major role in the intensive and diverse exploitation of resources. In Vale Boi, bipolar technology shows up in the archaeological record connected to evidence related to the intensification and diversification of resource exploration such as the above-mentioned grease obtention techniques. These have been shown by the constant presence of impact fractures in ungulate bones, low percentage of bone areas related to higher amounts of grease, and the presence of red deer bone fragments from bones with considerably higher marrow and grease contents. Other  indicators are both the constant presence of thermally altered quartz fragments that might be linked to stone boiling activities, and a large number of greywacke slabs with impact marks revealing their use as anvils. 
