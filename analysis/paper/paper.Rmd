...
area_by_platforms <- box_plot(techno_data, "DamagedPlatforms", "Area", "Number of Damaged Platforms", "Area (Length * Width)")
...
morpho_data_opposed_platforms <- opposed_plat_morpho()
...
plot_morpho_var(morpho_data_opposed_platforms)

```

\newline

To identify possible patterns of association among the qualitative variables used in our analysis \@ref(fig:morphoattributes), a Multiple Correspondence Analysis was performed. Results are presented in Figures \@ref(fig:mca). In this analysis raw material was used as a qualitative supplementary variable.
