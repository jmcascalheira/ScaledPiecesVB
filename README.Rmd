...
> Cascalheira, J., Horta, P., Bicho, N. (`r format(Sys.Date(), "%Y")`). _Compendium of R code and data for 'The role of lithic bipolar technology in Western Iberia’s Upper Paleolithic: the case of Vale Boi (southern Portugal)'_. Accessed `r format(Sys.Date(), "%d %b %Y")`. Online at <https://doi.org/xxx/xxx>
